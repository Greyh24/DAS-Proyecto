                ...
                <div class="md-4 center-block">
                    ...
                    <form class="form" action="./Paciente" method="POST">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="idPaciente"  value="<%= request.getParameter("idPaciente") %>" type="text" placeholder="Ingrese idPaciente"/>
                        </div><br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="email"  value="<%= request.getParameter("email") %>" type="text" placeholder="Ingrese email"/>
                        </div><br>
                        <div class="form-group">
                            <label  for="telefono" class="form-label">Telefono</label>
                            <input class="form-control" name="telefono"  value="<%= request.getParameter("telefono") %>" type="number" placeholder="Ingrese Telefono"/>
                        </div><br>
                        <div class="form-group">
                            <label  for="fechadeNacimiento" class="form-label">Fecha de Nacimiento</label>
                            <input class="form-control" name="fechadeNacimiento"  value="<%= request.getParameter("fechadeNacimiento") %>"  type="date" placeholder="Ingrese Fecha de Nacimiento"/>
                        </div><br>
                        <div class="form-group">
