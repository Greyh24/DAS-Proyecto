                ...
                <div class="md-4">
                    ...
                    <form class="form" action="./Paciente" method="POST">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="id" value="<%= request.getParameter("id") %>" type="text" placeholder="Ingrese ID"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="direccion" value="<%= request.getParameter("direccion") %>" type="text" placeholder="Ingrese Direccion"/>
                        </div>
                        <div class="form-group">
                            <label  for="telefono" class="form-label">Telefono</label>
                            <input class="form-control" name="telefono" value="<%= request.getParameter("direccion") %>" type="text" placeholder="Ingrese Telefono"/>
                        </div>
                        <div class="form-group">
