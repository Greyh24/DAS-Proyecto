                ...
                <div class="md-4 center-block">
                    ...
                    <form class="form" action="./Doctor" method="POST">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="id_Medico" type="text" placeholder="Ingrese ID"/>
                        </div><br>
                        <div class="form-group">
                            ...
                            <select class="form-control" style="width: 250px" name="idespecialidad"> 
                                ...
                                <% 
                                    try
                                    {
                                        ...
                                        {  
                                            %>
                                                <option value="<%=rs.getInt("CodE")%>"><%=rs.getString("Especialidad")%></option>
                            ...
                            <select class="form-control" style="width: 250px" name="idhorario"> 
                                ...
                                <% 
                                    try
                                    {
                                        ...
                                        {  
                                            %>
                                                <option value="<%=rs.getInt("CodTurno")%>"><%=rs.getString("DTurno")%></option>
